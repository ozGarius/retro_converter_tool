...
class SettingsDialog(QDialog):
    ...
    def load_settings(self):
        ...
        self.compress_level_spinbox.setValue(config.COMPRESS_LEVEL)
    ...
    def accept(self):
        ...
        config.COMPRESS_LEVEL = self.compress_level_spinbox.value()
        ...
        print(f"  COMPRESS_LEVEL: {config.COMPRESS_LEVEL}")
